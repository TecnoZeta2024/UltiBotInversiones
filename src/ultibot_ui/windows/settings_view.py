...
class SettingsView(QWidget):
    ...
    def _load_initial_data(self):
        ...
        self.main_event_loop.create_task(self._load_config_async())
        self.main_event_loop.create_task(self._load_real_trading_status_async())
    ...
    def _handle_save_button_clicked(self):
        self.main_event_loop.create_task(self._save_config_async())
    ...
    def _activate_real_trading_mode(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            ...
            self.main_event_loop.create_task(self._activate_real_trading_async())
        else:
    ...
    def _deactivate_real_trading_mode(self):
        ...
        self.main_event_loop.create_task(self._deactivate_real_trading_async())
