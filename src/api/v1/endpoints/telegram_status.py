...
from core.exceptions import CredentialError, TelegramNotificationError, NotificationError
from app_config import get_app_settings
from dependencies import get_credential_service, get_notification_service
